...
const UploadTransaction = () => {
  ...
  const handleUpload = async ({ file }) => {
    ...
    try {
      await axios.post(
        "https://bidvertiserserver.vercel.app/api/transactionupload/upload",
        formData,
        {
          headers: {
      ...
      notification.success({
        ...
        description: "Your transaction file has been uploaded successfully.",
      });
    } catch (error) {
      notification.error({
        message: "Upload Failed",
        description:
          "There was an error uploading your transaction file. Please try again.",
      });
    } finally {
      setLoading(false);
    }
