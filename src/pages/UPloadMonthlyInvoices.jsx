...
const UploadMonthlyInvoices = () => {
  ...
  const handleUpload = async ({ file }) => {
    ...
    try {
      await axios.post(
        "https://bidvertiserserver.vercel.app/api/monthlyinvoiceupload/upload", // Ensure this matches your backend route
        formData,
        {
          headers: {
      ...
      notification.success({
        ...
        description: "Your invoice file has been uploaded successfully.",
      });
    } catch (error) {
      notification.error({
...
export default UploadMonthlyInvoices;
